...
payloads = [
    {"filter": {"filters": [{"columnName": "name", "value": "CALABRESA - Brotinha"}]}, "data": [{"name": "CALABRESA - Brotinha", "price": "15"}]},
    {"filter": {"filters": [{"columnName": "name", "operator": "eq", "value": "CALABRESA - Brotinha"}]}, "data": [{"name": "CALABRESA - Brotinha", "price": "15"}]},
    {"filter": {"filters": [{"columnName": "name"}]}, "data": [{"name": "CALABRESA - Brotinha", "price": "15"}]},
]
