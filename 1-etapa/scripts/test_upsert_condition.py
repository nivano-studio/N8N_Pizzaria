...
payloads = [
    {"filter": {"filters": [{"columnName": "name", "condition": "equals", "value": "CALABRESA - Brotinha"}]}, "data": [{"name": "CALABRESA - Brotinha", "price": "15"}]},
    {"filter": {"filters": [{"columnName": "name", "condition": "eq", "value": "CALABRESA - Brotinha"}]}, "data": [{"name": "CALABRESA - Brotinha", "price": "15"}]},
    {"filter": {"filters": [{"columnName": "name", "condition": "=", "value": "CALABRESA - Brotinha"}]}, "data": [{"name": "CALABRESA - Brotinha", "price": "15"}]},
    {"filter": {"filters": [{"columnName": "name", "condition": "equal", "value": "CALABRESA - Brotinha"}]}, "data": [{"name": "CALABRESA - Brotinha", "price": "15"}]},
]
